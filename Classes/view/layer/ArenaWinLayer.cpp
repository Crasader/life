...
void ArenaWinLayer::onEnter()
{
    Layer::onEnter();
    startPlotListener = EventListenerCustom::create(START_PLOT, CC_CALLBACK_1(ArenaWinLayer::startPlot, this));
...
bool ArenaWinLayer::init()
{
    ...
    auto root = CSLoader::createNode(ARENA_WIN_UI);
    action = CSLoader::createTimeline(ARENA_WIN_UI);
    ...
    action->setAnimationEndCallFunc("in", CC_CALLBACK_0(ArenaWinLayer::openTouch, this));
...
void ArenaWinLayer::setupView(cocos2d::EventCustom *event)
{
...
void ArenaWinLayer::openTouch()
{
    getEventDispatcher()->removeAllEventListeners();
    auto listener = EventListenerTouchOneByOne::create();
    listener->onTouchBegan = CC_CALLBACK_2(ArenaWinLayer::onTouchesBegan, this);
    listener->setSwallowTouches(true);
    getEventDispatcher()->addEventListenerWithSceneGraphPriority(listener, this);
...
bool ArenaWinLayer::onTouchesBegan(cocos2d::Touch* touch, cocos2d::Event* event)
{
...
void ArenaWinLayer::startPlot(cocos2d::EventCustom *event)
{
