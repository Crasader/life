...
////#else
//    "com.pj.life.diamond120",
//    "com.pj.life.diamond600",
//    "com.pj.life.diamond1360",
//    "com.pj.life.diamond2560",
//    "com.pj.life.diamond6560",
//    "com.pj.life.diamond12960",
//    "com.pj.life.stonepack",
//    "com.pj.life.itempack1",
//    "com.pj.life.itempack2",
//    "com.pj.life.vitpack1",
//    "com.pj.life.discountpetpack",
//    "com.pj.life.discountstonepack",
//    "com.pj.life.discountitempack"
////#endif
//};
...
void IOSiAP_Bridge::initPidMap(std::map<int, std::string> &map)
{
    pidMap = map;
}
bool IOSiAP_Bridge::canMakePay()
{
    if (!iap->CanMakePay()) {
        MessageBox("您的手机没有打开程序内付费购买", "提示");
        iOSPayHelper::getInstance()->payError(productID);
        return false;
    }
    return true;
}
...
void IOSiAP_Bridge::onRequestProductsFinish(void)
{
    ...
    if (pidMap.find(productID) == pidMap.end()) {
        onRequestProductsError(0);
        return;
    }
    //    identifier = idenStr[productID];
    identifier = pidMap[productID];
...
{
    iOSPayHelper::getInstance()->paySuccess(productId);
    Director::getInstance()->getRunningScene()->removeChildByTag(10000);
}
